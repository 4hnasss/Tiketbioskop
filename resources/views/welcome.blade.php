...
<body class="min-h-screen text-[#14274E]">
    ...
    <div class="max-w-7xl mx-auto py-10 px-6">
        {{-- Alert Messages --}}
        @if(session('error'))
            <div class="bg-red-50 border-2 border-red-400 text-red-800 p-4 mb-6 rounded-xl shadow-md">
        ...
        @if(session('success'))
            <div class="bg-green-50 border-2 border-green-400 text-green-800 p-4 mb-6 rounded-xl shadow-md">
        ...
        {{-- Welcome Card --}}
        <div class="bg-gradient-to-br from-[#1E56A0] to-[#14274E] rounded-2xl shadow-xl p-6 mb-8 text-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            ...
            <div class="bg-white/80 backdrop-blur-md rounded-xl shadow-lg border-2 border-[#D6E4F0] hover:shadow-xl transition transform hover:scale-105">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <a href="{{ route($menu['route']) }}" class="block bg-white/80 backdrop-blur-md rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition p-6 border-2 border-[#D6E4F0] group">
